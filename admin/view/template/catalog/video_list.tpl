...
<div id="content">
	...
	<?php } ?>
	 ...
	 <div class="box">
		<div class="heading">
			<h1><img src="view/image/videos.png" alt="" /> <?php echo $heading_title; ?></h1>
	    	...
	    	<form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
	        	<table class="list">
		          	<thead>
		          		...
		          		<td class="left" width="400"><?php if ($sort == 'name') { ?>
			            ...
			            <td class="left" ><?php echo $column_url; ?></td>
		          		<td class="right" width="70"><?php echo $column_action; ?></td>
		          	</thead>
            		...
            		<tr>
			            ...
			            <td class="left"><?php echo $video['video_url']; ?></td>
			            <td class="right">
			            <?php if($video['action']){
			            		foreach ($video['action'] as $action) { ?>
