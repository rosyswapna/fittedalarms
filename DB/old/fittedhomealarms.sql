...
--
-- Host: localhost
-- Generation Time: Jul 01, 2013 at 07:50 AM
...
--
-- Dumping data for table `ft_manufacturer`
--

INSERT INTO `ft_manufacturer` (`manufacturer_id`, `name`, `image`, `sort_order`) VALUES
...
--
-- Dumping data for table `ft_manufacturer_to_store`
--

INSERT INTO `ft_manufacturer_to_store` (`manufacturer_id`, `store_id`) VALUES
(5, 0),
(6, 0),
(7, 0),
(8, 0),
...
--
-- Dumping data for table `ft_product_attribute`
--

INSERT INTO `ft_product_attribute` (`product_id`, `attribute_id`, `language_id`, `text`) VALUES
(43, 2, 1, '1'),
(47, 4, 1, '16GB'),
(43, 4, 1, '8gb'),
(42, 3, 1, '100mhz'),
...
--
-- Dumping data for table `ft_product_discount`
--

INSERT INTO `ft_product_discount` (`product_discount_id`, `product_id`, `customer_group_id`, `quantity`, `priority`, `price`, `date_start`, `date_end`) VALUES
...
--
-- Dumping data for table `ft_product_option`
--

INSERT INTO `ft_product_option` (`product_option_id`, `product_id`, `option_id`, `option_value`, `required`) VALUES
(224, 35, 11, '', 1),
...
--
-- Dumping data for table `ft_product_option_value`
--

INSERT INTO `ft_product_option_value` (`product_option_value_id`, `product_option_id`, `product_id`, `option_id`, `option_value_id`, `quantity`, `subtract`, `price`, `price_prefix`, `points`, `points_prefix`, `weight`, `weight_prefix`) VALUES
...
--
-- Dumping data for table `ft_product_related`
--

INSERT INTO `ft_product_related` (`product_id`, `related_id`) VALUES
(40, 42),
(41, 42),
(42, 40),
(42, 41);
...
--
-- Dumping data for table `ft_product_special`
--

INSERT INTO `ft_product_special` (`product_special_id`, `product_id`, `customer_group_id`, `priority`, `price`, `date_start`, `date_end`) VALUES
...
(133, 0, 'config', 'config_encryption', '63f19cf2cc75ba2c812f4d68977032ac', 0),
...
(131, 0, 'config', 'config_email', 'lorathantony@acube.co', 0),
...
(132, 0, 'config', 'config_url', 'http://fittedalrams.local/fittedalrams/', 0);
...
(1, 1, 'admin', '87a03b987540a526459fcaac99971e159f8279e9', 'c613ca4b0', '', '', 'lorathantony@acube.co', '', '', 1, '2013-07-01 12:06:49');
