...
<p style="margin-left:50px;"><?php echo $address;?></p>
  <p style="margin-top: 0px; margin-bottom: 20px;margin:0 auto;"><?php echo $text_greeting; ?></p>
  <?php if ($customer_id) { ?>
  ...
  <table style="border-collapse: collapse; width: 100%; border-top: 1px solid #DDDDDD; border-left: 1px solid #DDDDDD; margin-bottom: 20px;">
    ...
    <?php if($installation_charge){?>

    <tr>
        <td style="font-size: 12px; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;" colspan="4"><b>Installation Charge:</b></td>
        <td style="font-size: 12px; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;"><?php echo $installation_charge; ?></td>
    </tr>
  ...
  <p style="margin-top: 0px; margin-bottom: 20px;color:#000;"><?php echo $text_mail_body; ?></p>
