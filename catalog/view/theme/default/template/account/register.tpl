    ...
    <div class="content">
      <table class="form">
        ...
        <tr>
          ...
          <td><input type="text" name="email" value="<?php echo $email; ?>" style="border:#D4D4D4 dotted 1px;"/>
            <?php if ($error_email) { ?>
    ...
    <div class="content">
      <table class="form">
        <tr>
          ...
          <td><input type="text" name="company" value="<?php echo $company; ?>" style="border:#D4D4D4 dotted 1px;"/></td>
        </tr>        
        ...
        <tr id="company-id-display">
          ...
          <td><input type="text" name="company_id" value="<?php echo $company_id; ?>" style="border:#D4D4D4 dotted 1px;"/>
        ...
        <tr id="tax-id-display">
          ...
          <td><input type="text" name="tax_id" value="<?php echo $tax_id; ?>" style="border:#D4D4D4 dotted 1px;"/>
            <?php if ($error_tax_id) { ?>
        ...
        <tr>
          ...
          <td><input type="text" name="address_1" value="<?php echo $address_1; ?>" style="border:#D4D4D4 dotted 1px;"/>
        ...
        <tr>
          ...
          <td><input type="text" name="address_2" value="<?php echo $address_2; ?>" style="border:#D4D4D4 dotted 1px;"/></td>
        </tr>
        <tr>
          <td><span class="required">*</span> <?php echo $entry_city; ?></td>
          <td><input type="text" name="city" value="<?php echo $city; ?>" style="border:#D4D4D4 dotted 1px;"/>
            <?php if ($error_city) { ?>
        ...
        <tr>
          ...
          <td><input type="text" name="postcode" value="<?php echo $postcode; ?>" style="border:#D4D4D4 dotted 1px;"/>
        ...
        <tr>
          ...
          <td><select name="country_id" style="border:#D4D4D4 dotted 1px;">
        ...
        <tr>
          ...
          <td><select name="zone_id" style="border:#D4D4D4 dotted 1px;">
            </select>
            <?php if ($error_zone) { ?>
