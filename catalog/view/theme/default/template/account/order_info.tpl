  ...
  <table class="list">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="right" colspan="2"><?php echo $product['total']; ?></td>
         <!--<td class="right">
         <a href="<?php echo $product['return']; ?>"><img src="catalog/view/theme/default/image/return.png" alt="<?php echo $button_return; ?>" title="<?php echo $button_return; ?>" /></a>
        </td>-->
      </tr>
      <?php } ?>
    ...
    <tfoot>
      ...
      <tr>
        ...
        <td class="right" colspan="2"><?php echo $total['text']; ?></td>
        <?php if ($products) { ?>
        <!--<td></td>-->
        <?php } ?>
      </tr>
