    ...
    <link rel="stylesheet" type="text/css" href="view/theme/aquacart/stylesheet/invoice.css" />
    </head>
    <body>
    <?php foreach ($orders as $order) { ?>
    <div style="page-break-after: always;">
      <h1><?php echo $text_invoice; ?><?php echo $logo; ?></h1>
      ...
      <table class="address">
        ...
        <tr>
          ...
          <td><?php echo $order['installation_address']; ?></td>
        </tr>
      </table>
      <table class="product">
        <tr class="heading">
