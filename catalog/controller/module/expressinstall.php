<?php
class ControllerModuleExpressinstall extends Controller {
	private $error_expressinstall = array(); 
    public function index() {
        $this->language->load('module/expressinstall'); //Optional. This calls for your language file
 ...
 //End of category
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/expressinstall.tpl')) { //if file exists in your current template folder
            $this->template = $this->config->get('config_template') . '/template/module/expressinstall.tpl'; //get it
        } else {
            $this->template = 'default/template/module/expressinstall.tpl'; //or get the file from the default folder
        }
