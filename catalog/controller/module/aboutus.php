<?php
class ControllerModuleAboutus extends Controller {
	private $error_aboutus = array(); 
    public function index() {
        $this->language->load('module/aboutus'); //Optional. This calls for your language file
 ...
 //End of category
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/aboutus.tpl')) { //if file exists in your current template folder
            $this->template = $this->config->get('config_template') . '/template/module/aboutus.tpl'; //get it
        } else {
            $this->template = 'default/template/module/aboutus.tpl'; //or get the file from the default folder
        }
