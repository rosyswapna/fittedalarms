<?php
class ControllerInformationTermscondition extends Controller {
	private $error_termscondition = array(); 
    public function index() {
        $this->language->load('information/termscondition'); //Optional. This calls for your language file
 ...
 //End of category
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/information/termscondition.tpl')) { //if file exists in your current template folder
            $this->template = $this->config->get('config_template') . '/template/information/termscondition.tpl'; //get it
        } else {
            $this->template = 'default/template/information/termscondition.tpl'; //or get the file from the default folder
        }
