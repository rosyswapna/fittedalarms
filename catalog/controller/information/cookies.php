...
class ControllerInformationCookies extends Controller {
	private $error_cookies = array(); 
    public function index() {
        $this->language->load('information/cookies'); //Optional. This calls for your language file
 ...
 //End of category
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/information/cookies.tpl')) { //if file exists in your current template folder
            $this->template = $this->config->get('config_template') . '/template/information/cookies.tpl'; //get it
        } else {
            $this->template = 'default/template/information/cookies.tpl'; //or get the file from the default folder
        }
