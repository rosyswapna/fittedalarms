<?php
class ControllerInformationAreascovered extends Controller {
	private $error_areascovered = array(); 
    public function index() {
        $this->language->load('information/areascovered'); //Optional. This calls for your language file
 ...
 //End of category
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/information/areascovered.tpl')) { //if file exists in your current template folder
            $this->template = $this->config->get('config_template') . '/template/information/areascovered.tpl'; //get it
        } else {
            $this->template = 'default/template/information/areascovered.tpl'; //or get the file from the default folder
        }
