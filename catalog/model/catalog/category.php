...
class ModelCatalogCategory extends Model {
	...
	$query = $this->db->query("SELECT fpc.product_id FROM " . DB_PREFIX . "product_to_category fpc WHERE fpc.category_id = '" . (int)$cat_id . "' ");
		//echo "SELECT fpc.product_id FROM " . DB_PREFIX . "product_to_category fpc WHERE fpc.category_id = '" . (int)$cat_id . "' ";
		return $query->row;
	}
