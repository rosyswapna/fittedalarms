...
class ModelAccountInstallationAddress extends Model {
	...
	public function deleteAddress($address_id) {
		$this->db->query("DELETE FROM " . DB_PREFIX . "installation_address WHERE address_id = '" . (int)$address_id . "' AND customer_id = '" . (int)$this->customer->getId() . "'");
	}	
	
	public function getAddress($address_id) {
		$address_query = $this->db->query("SELECT DISTINCT * FROM " . DB_PREFIX . "installation_address WHERE address_id = '" . (int)$address_id . "' AND customer_id = '" . (int)$this->customer->getId() . "'");
	...
	public function getAddresses() {
		...
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "installation_address WHERE customer_id = '" . (int)$this->customer->getId() . "'");
	...
	public function getTotalAddresses() {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "installation_address WHERE customer_id = '" . (int)$this->customer->getId() . "'");
