...
<div id="content"><?php echo $content_top; ?>
  ...
  <!-- <div id="checkout">
    ...
    <div id="payment-address">
      <div class="checkout-heading"><span><?php echo $text_checkout_account; ?></span><hr /></hr></div>
      <div class="checkout-content"></div>
    </div>
    <?php } else { ?>
    <div id="payment-address">
      <div class="checkout-heading"><span><?php echo $text_checkout_payment_address; ?></span><hr /></hr></div>
      <div class="checkout-content"></div>
    </div>

    <div id="installation-address">
      <div class="checkout-heading"><span><?php echo $text_checkout_installation_address; ?></span><hr /></hr></div>
      <div class="checkout-content"></div>
    </div>
    ...
    <?php if ($shipping_required) { ?>
      ...
      <div class="checkout-heading"><?php echo $text_checkout_shipping_address; ?><hr /></hr></div>
      <div class="checkout-content"></div>
    </div>
    
				<div id="shipping-method" style="display: none">
			
      <div class="checkout-heading"><?php echo $text_checkout_shipping_method; ?><hr /></hr></div>
      <div class="checkout-content"></div>
    </div>
    <?php } ?>

    <div id="confirm">
      <div class="checkout-heading"><?php echo $text_checkout_confirm; ?><hr /></hr></div>
      <div class="checkout-content"></div>
    </div>

    <div id="payment-method">
      <div class="checkout-heading"><?php echo $text_checkout_payment_method; ?><hr /></hr></div>
      <div class="checkout-content"></div>
    </div>
		...
		success: function(html) {
			...
			$.ajax({
				...
				success: function(html) {
					...
					$('#payment-address .checkout-content').html('<table><tr><td>'+output+'</td></tr><tr><td>'+html+'</td></tr></table>');
...
$('#button-login').live('click', function() {
	//alert($(".login_titles :input").val());
	//alert($(".login_titles :password").val());
	$.ajax({
		url: 'index.php?route=checkout/login/validate',
		type: 'post',
		data: $('.login_titles :input'),
		dataType: 'json',
		beforeSend: function() {
		...
		success: function(json) {
			...
			//	}	
				...
				<?php } else { ?>
					...
					$.ajax({
						url: 'index.php?route=checkout/installation_address',
						dataType: 'html',
						success: function(html) {
							$('#installation-address .checkout-content').html(html);
						
							$('#payment-address .checkout-content').slideUp('slow');
							
							$('#installation-address .checkout-content').slideDown('slow');
							
							$('#payment-address .checkout-heading a').remove();
							$('#installation-address .checkout-heading a').remove();
...
$('#button-installation-address').live('click', function() {
	$.ajax({
		url: 'index.php?route=checkout/installation_address/validate',
		type: 'post',
		data: $('#installation-address input[type=\'text\'], #installation-address input[type=\'password\'], #installation-address input[type=\'checkbox\']:checked, #installation-address input[type=\'radio\']:checked, #installation-address input[type=\'hidden\'], #installation-address select'),
		dataType: 'json',
		beforeSend: function() {
			$('#button-installation-address').attr('disabled', true);
			$('#button-installation-address').after('<span class="wait">&nbsp;<img src="catalog/view/theme/default/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
			$('#button-installation-address').attr('disabled', false);
			$('.wait').remove();
		},			
		success: function(json) {
			$('.warning, .error').remove();
			...
			if (json['redirect']) {
				...
				if (json['error']['warning']) {
					$('#installation-address .checkout-content').prepend('<div class="warning" style="display: none;">' + json['error']['warning'] + '<img src="catalog/view/theme/default/image/close.png" alt="" class="close" /></div>');
					
					$('.warning').fadeIn('slow');
				}
								
				if (json['error']['firstname']) {
					$('#installation-address input[name=\'firstname\']').after('<span class="error">' + json['error']['firstname'] + '</span>');
				}
				
				if (json['error']['lastname']) {
					$('#installation-address input[name=\'lastname\']').after('<span class="error">' + json['error']['lastname'] + '</span>');
				}	
				
				if (json['error']['telephone']) {
					$('#installation-address input[name=\'telephone\']').after('<span class="error">' + json['error']['telephone'] + '</span>');
				}		
			...
			//	}	
				...
				if (json['error']['address_1']) {
					$('#installation-address input[name=\'address_1\']').after('<span class="error">' + json['error']['address_1'] + '</span>');
				}	
				
				if (json['error']['city']) {
					$('#installation-address input[name=\'city\']').after('<span class="error">' + json['error']['city'] + '</span>');
				}	
				
				if (json['error']['postcode']) {
					$('#installation-address input[name=\'postcode\']').after('<span class="error">' + json['error']['postcode'] + '</span>');
				}	
				
				if (json['error']['country']) {
					$('#installation-address select[name=\'country_id\']').after('<span class="error">' + json['error']['country'] + '</span>');
				}	
				
				if (json['error']['zone']) {
					$('#installation-address select[name=\'zone_id\']').after('<span class="error">' + json['error']['zone'] + '</span>');
				}
			} else {
				<?php if ($shipping_required) { ?>
				$.ajax({
					...
					success: function(html) {
						...
						$('#installation-address .checkout-content').slideUp('slow');
				...
				$('#button-shipping-address').click();
						...
						$('#installation-address .checkout-heading').append('<a><?php echo $text_modify; ?></a>');	
					},
					error: function(xhr, ajaxOptions, thrownError) {
						alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
					}
...
$('#button-confirm').live('click', function() {
	$.ajax({
		...
		success: function(html) {
			...
			$('#confirm .checkout-heading').append('<a><?php echo $text_modify; ?></a>');	
		},
		error: function(xhr, ajaxOptions, thrownError) {
			alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
		}
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				$.ajax({
					url: 'index.php?route=checkout/proceed_to_payment',
					dataType: 'html',
					success: function(html) {
						$('#proceed-to-payment .checkout-content').html(html);
						
						$('#payment-method .checkout-content').slideUp('slow');
						
						$('#proceed-to-payment .checkout-content').slideDown('slow');
