...
$this->data['text_menus'] = $this->language->get('text_menus');
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['features'] = $this->url->link('catalog/features', 'token=' . $this->session->data['token'], 'SSL');
			...
			$this->data['bestseller'] = $this->url->link('catalog/bestseller', 'token=' . $this->session->data['token'], 'SSL');
