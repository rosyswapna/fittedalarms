...
$this->data['video'] = $product_info['video'];
			...
			$packages=$this->model_catalog_product->getProductPackages($this->request->get['product_id']);
			...
			$this->data['description'] = html_entity_decode($product_info['description'], ENT_QUOTES, 'UTF-8');
				...
				$this->data['moreinfo'] = html_entity_decode($product_info['more_info'], ENT_QUOTES, 'UTF-8');
			
			$this->data['attribute_groups'] = $this->model_catalog_product->getProductAttributes($this->request->get['product_id']);
$this->data['recommendedfors'] = $this->model_catalog_product->getProductRecommendations($this->request->get['product_id']);
