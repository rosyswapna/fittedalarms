...
$c_mod_strings = return_specified_module_language($language,  $currentModule);
$smarty->assign("MOD", $c_mod_strings);

$smarty->assign("EMMOD", $mod_strings);
...
if(isset($_REQUEST['ajax']) && $_REQUEST['ajax'] != '')
	...
	$smarty->display("modules/EMAILMaker/Popup.tpl");
