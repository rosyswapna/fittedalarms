...
function str_get_html2($str, $lowercase=true) {
    $dom = new simple_html_dom2;
...
function dump_html_tree2($node, $show_attr=true, $deep=0) {
    ...
    foreach($node->nodes as $c)
        dump_html_tree2($c, $show_attr, $deep+1);
}

// get dom form file (deprecated)
function file_get_dom2() {
    $dom = new simple_html_dom2;
    $args = func_get_args();
    $dom->load(call_user_func_array('file_get_contents', $args), true);
    return $dom;
...
function str_get_dom2($str, $lowercase=true) {
    $dom = new simple_html_dom2;
    $dom->load($str, $lowercase);
    return $dom;
}
...
class simple_html_dom_node2 {
    ...
    function dump($show_attr=true) {
        dump_html_tree2($this, $show_attr);
    }
