...
<tr>
	<td style="padding-left:10px;padding-right:50px" class="moduleName" nowrap>{$APP.$CATEGORY} > <a class="hdrLink" href="index.php?action=ListEmailTemplates&module=EMAILMaker&parenttab={$CATEGORY}">{$MOD.LBL_TEMPLATE_GENERATOR}</a></td>
