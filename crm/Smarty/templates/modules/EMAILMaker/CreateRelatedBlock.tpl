...
function changeSecOptions()
{
      ...
      new Ajax.Request(
                          ...
                          {queue: {position: 'end', scope: 'command'},
                                  method: 'post',
                                  postBody: 'action=EMAILMakerAjax&mode=columns&file=EditRelatedBlock&module=EMAILMaker&secmodule='+secmodule,
      ...
      new Ajax.Request(
                          ...
                          {queue: {position: 'end', scope: 'command'},
                                  method: 'post',
                                  postBody: 'action=EMAILMakerAjax&mode=stdcriteria&file=EditRelatedBlock&module=EMAILMaker&secmodule='+secmodule,
                                  onComplete: function(response) {
